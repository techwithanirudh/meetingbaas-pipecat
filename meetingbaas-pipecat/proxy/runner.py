...
async def configure(
    ...
    parser.add_argument(
        "--websocket-url", type=str, default="ws://localhost:8765", help="Pipecat WebSocket URL"
    )
    parser.add_argument(
    ...
    return (args.host, args.port, args.websocket_url, args.sample_rate, args.channels, args)